...
.cabecalho {
  ...
  padding-bottom: 1.4mm; margin-bottom: 2.6mm;
}
.cabecalho h1 { font-size: 16pt; color: var(--navy); font-weight: 700; letter-spacing: 0.3pt; }
...
.aviso-edicao {
  ...
  border-left: 3px solid var(--gold); padding: 1.3mm 3mm; margin-bottom: 2.2mm;
}

.secao-titulo {
  font-size: 9.5pt; color: var(--navy); font-weight: 700;
  border-bottom: 0.4mm solid var(--linha); padding-bottom: 0.8mm; margin-bottom: 1.5mm;
  text-transform: uppercase; letter-spacing: 0.4pt;
}

.conclusoes { list-style: none; margin-bottom: 2.4mm; }
.conclusoes li { position: relative; padding-left: 4mm; margin-bottom: 0.9mm; font-size: 8.5pt; line-height: 1.26; }
.conclusoes li::before { content: "\\25CF"; color: var(--gold); position: absolute; left: 0; font-size: 6.5pt; top: 0.8mm; }

.cartoes-macro { display: flex; gap: 2.6mm; margin-bottom: 2.2mm; }
.cartao-macro {
  flex: 1; border: 0.3mm solid var(--linha); border-radius: 1.5mm; padding: 1.8mm 2.1mm;
  background: #FAFBFC;
}
.cartao-macro .rot { font-size: 7.2pt; color: var(--cinza); text-transform: uppercase; letter-spacing: 0.3pt; }
.cartao-macro .val { font-size: 11pt; color: var(--navy); font-weight: 700; margin: 0.5mm 0; }
...
.faixa-amplitude {
  ...
  border-radius: 1.5mm; padding: 2mm 3mm; margin-bottom: 2.2mm; background: #FAFBFC;
}
.faixa-amplitude .num { font-size: 12pt; font-weight: 700; color: var(--navy); }
...
.confronto-janelas .item .linha { font-size: 8.5pt; margin-top: 0.6mm; }

.notas-edicao { font-size: 7.6pt; color: var(--cinza); line-height: 1.28; }
...
.notas-edicao li { padding-left: 3mm; position: relative; margin-bottom: 0.7mm; }
...
table.quadro th {
  ...
  padding: 0.9mm 1.1mm; font-weight: 700;
}
table.quadro td { padding: 0.7mm 1.1mm; border-bottom: 0.2mm solid var(--linha); vertical-align: top; overflow-wrap: break-word; line-height: 1.16; }
...
def pagina4(ctx):
    ...
    # Ticker precisa de largura suficiente para "BRBI11" (o mais largo) sem
    # quebrar linha: white-space:nowrap (CSS) + coluna alargada.
    tabela = ('<table class="quadro"><colgroup>'
              '<col style="width:16mm"><col style="width:21mm"><col style="width:12mm">'
              '<col style="width:20mm"><col style="width:12mm"><col style="width:12mm">'
              '<col style="width:12mm"><col style="width:19mm"><col>'
              '</colgroup><thead><tr>'
...
(function() {
  ...
  paginas.forEach(function(pagina, idx) {
    ...
    if (vazioPct > 35) motivos.push('vazio>35%');
